...
class AnnotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annotation" do
    assert_difference('Annotation.count') do
      post annotations_url, params: { annotation: { body: @annotation.body, friend_id: @annotation.friend_id } }
    end
  ...
  test "should update annotation" do
    patch annotation_url(@annotation), params: { annotation: { body: @annotation.body, friend_id: @annotation.friend_id } }
